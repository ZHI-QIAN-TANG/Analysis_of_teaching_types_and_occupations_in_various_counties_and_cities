...
def index(request):
    df = pd.read_csv('data/各縣市每年總薪資之平均.csv', header=None, skiprows=2, encoding='utf-8', dtype=str)
    ...
    return render(request, 'ASCindex.html', {'years': years, 'data': data_json, 'growth_rates': growth_rates_json})
